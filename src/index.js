...
const dima = new User ('Dimon', new Date());
const alina = new User ('Alina', new Date());
const bohdan = new User ('Bohdan', new Date());
...
const book333 = new Book('333', new Date(), dima, authors);
...
console.log(dima.publishedBooks);
console.log(dima.friendsNames);
